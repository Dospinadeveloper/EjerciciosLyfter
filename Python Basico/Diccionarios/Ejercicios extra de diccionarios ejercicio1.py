...
for sale in sales:
    for item in sale['items']:
        ...
        # Sumamos el precio al total acumulado de ese UPC
        result[upc] = result.get(upc, 0) + price

# Imprimir cada item con un salto de línea
for upc, total in result.items():
    #print(f"UPC: {upc} Total: ${total:.2f}")
    print(f"UPC: {upc} Total: ${total}")
